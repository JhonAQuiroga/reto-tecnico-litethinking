...
/**
 * Filtro de Spring Security que intercepta cada request HTTP,
 * extrae el token JWT del header Authorization y,
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (StringUtils.hasText(token) && jwtTokenProvider.esValido(token)) {
            String email = jwtTokenProvider.extraerEmail(token);
